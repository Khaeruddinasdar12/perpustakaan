...
{
	partial class FormBiodataMahasiswa
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.agama.SelectedIndexChanged += new System.EventHandler(this.AgamaSelectedIndexChanged);
			// 
			// tempatlahir
			// 
			...
			this.jkel.SelectedIndexChanged += new System.EventHandler(this.JkelSelectedIndexChanged);
			// 
			// tampiljkel
			// 
			...
			this.propinsi.Text = "Pilih Propinsi";
			this.propinsi.SelectedIndexChanged += new System.EventHandler(this.PropinsiSelectedIndexChanged);
			// 
			// tampilpropinsi
			// 
			...
			this.textBox17.TextChanged += new System.EventHandler(this.TextBox17TextChanged);
			// 
			// label19
			// 
			...
			this.dataGridView1.Size = new System.Drawing.Size(838, 147);
			...
			// button5
			// 
			this.button5.Location = new System.Drawing.Point(310, 347);
			...
			this.Name = "FormBiodataMahasiswa";
			this.Text = "Input Biodata Mahasiswa";
