...
namespace tugas5_no1_172296_khaeruddinasdar_h
{
	...
	public partial class InputDataMhs : Form
	{
		MySqlCommand query;
		Koneksi sambung;
		...
		void SavetodbClick(object sender, EventArgs e)
		{
			sambung = new Koneksi();
			sql = "INSERT INTO mahasiswa (stb, nama, alamat, nilai_tugas, nilai_mid, nilai_final, nilai_akhir, " +
				"nilai_huruf, keterangan) " +
				"VALUES ('"+inputstb.Text+"', '"+inputnama.Text+"', '"+alamat.Text+"', "+inputNT.Text+", "+inputMID.Text+", "+inputFinal.Text+", "+inputFinal.Text+", '"+nilaihuruf.Text+"', " +
				"'"+ket.Text+"')";
			...
			FormOperationDML show = new FormOperationDML();
				show.Refresh();
				show.TampilDalamTable();
